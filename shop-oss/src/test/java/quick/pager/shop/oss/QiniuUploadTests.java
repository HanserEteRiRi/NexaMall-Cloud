...
public class QiniuUploadTests {
    ...
    public void qiniuUpload() {
        ...
        httpClientUploadFile("http://127.0.0.1:9999/oss/qiniu/upload", new File("/Users/siguiyang/IdeaProjects/nexamall-cloud/shop-oss/src/main/resources/banner.txt"), params);
    }
